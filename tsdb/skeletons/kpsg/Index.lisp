...
((( :path . "base") (:content . "base"))
 (( :path . "case-alt") (:content . "case-alt"))
 (( :path . "coord") (:content . "coord"))
 (( :path . "honor") (:content . "honor"))
 (( :path . "mrs") (:content . "MRS test suite"))
 (( :path . "rel-cl") (:content . "rel-cl"))
 (( :path . "self-lvc") (:content . "self-lvc")))